...
public class MainMenuFrame extends JFrame implements WindowListener, ActionListener, DocumentListener
{
    RoundedRectPanel mainPanel = new RoundedRectPanel();
    
    GridBagConstraints mainPanelConstraint = new GridBagConstraints();
    GridBagConstraints inPanelConstraint = new GridBagConstraints();
    
    JLabel welcomeLbl = new JLabel("Insert the username");
    
    JPanel choicePanel = new JPanel();
    
    private Font font = new Font("Verdana", Font.BOLD, 28);
    private Font font1 = new Font("Verdana", Font.BOLD, 12);
    
    protected JTextField usernameTxt = new JTextField();
    
    protected JButton loginBtn = new JButton("search");
    
    protected String username;
    
    protected JLabel error = new JLabel("conversation with user is already opened");
    
    Border blackBorder = BorderFactory.createLineBorder(Color.black);
    
    private String ownUsername;
    
    public MainMenuFrame(String ownUsername)
    {
        super();
        ...
        setResizable(false);
        setTitle("ChatterED - " + ownUsername);
        addWindowListener(this);
        setLayout(new GridBagLayout());
        mainPanel.setLayout(new GridBagLayout());
        
        inPanelConstraint.insets = new Insets(30,20,10,20);
        ...
        inPanelConstraint.insets = new Insets(10,40,40,100);
        inPanelConstraint.gridy = 4;
        inPanelConstraint.gridx = 1;
        
        error.setFont(font1);
        error.setVisible(false);
        mainPanel.add(error, inPanelConstraint);
